...
- `BASIC_AUTH_USER`
- `BASIC_AUTH_PASS`
- `BASIC_AUTH_USER_2`（可选，第二套 Basic Auth）
- `BASIC_AUTH_PASS_2`（可选，第二套 Basic Auth）
- `ADMIN_TOKEN`
- `PORT`
- `HOST`
...
鉴权：HTTP Basic Auth（支持 `BASIC_AUTH_USER`/`BASIC_AUTH_PASS` 和可选的第二套 `BASIC_AUTH_USER_2`/`BASIC_AUTH_PASS_2`）。
